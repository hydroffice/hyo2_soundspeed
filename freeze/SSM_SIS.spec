...
#
# python /path/to/pyinstaller.py SSM-SIS.spec
#
# The resulting .exe file is placed in the dist/SSM-SIS folder.
#
# It may require to manually copy DLLs and other files.
#
# Uploading to BitBucket: curl -s -v -u giumas:password -X POST https://api.bitbucket.org/2.0/repositories/hydroffice/hyo_sound_speed_manager/downloads -F files=@SSM-SIS.1.0.0.zip
