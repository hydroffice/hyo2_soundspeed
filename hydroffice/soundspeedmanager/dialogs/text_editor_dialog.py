...
from hydroffice.soundspeedmanager.dialogs.text_editor import TextEditor
...
class TextEditorDialog(AbstractDialog):
    ...
    def __init__(self, title, basename, body, main_win, lib, parent=None, init_size=QtCore.QSize(600, 400)):
        ...
        self.mainWidget = QtGui.QMainWindow()
    ...
    def on_save_file(self):
        ...
        selection, _ = QtGui.QFileDialog.getSaveFileName(self, "Save file", output_path,
