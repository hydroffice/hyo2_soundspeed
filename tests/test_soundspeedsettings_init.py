...
class TestSoundSpeedSettingsInit(unittest.TestCase):
    ...
    def test_has_version(self):
        from hydroffice.soundspeedsettings import __version__
    ...
    def test_doc(self):
        from hydroffice.soundspeedsettings import __doc__
    ...
    def test_author(self):
        from hydroffice.soundspeedsettings import __author__
    ...
    def test_license(self):
        from hydroffice.soundspeedsettings import __license__
    ...
    def test_copyright(self):
        from hydroffice.soundspeedsettings import __copyright__
