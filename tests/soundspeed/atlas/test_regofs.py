...
class TestSoundSpeedAtlasGomofs(unittest.TestCase):
    ...
    def test_creation_of_Cbofs(self):
        ...
        cbofs = RegOfs(data_folder=prj.cbofs_folder, prj=prj, model=RegOfs.Model.CBOFS)
    ...
    def test_creation_of_Dbofs(self):
        prj = SoundSpeedLibrary(data_folder=self.cur_dir)
        dbofs = RegOfs(data_folder=prj.dbofs_folder, prj=prj, model=RegOfs.Model.DBOFS)
    ...
    def test_creation_of_Ngofs(self):
        prj = SoundSpeedLibrary(data_folder=self.cur_dir)
        ngofs = RegOfs(data_folder=prj.ngofs_folder, prj=prj, model=RegOfs.Model.NGOFS)
    ...
    def test_creation_of_Tbofs(self):
        prj = SoundSpeedLibrary(data_folder=self.cur_dir)
        tbofs = RegOfs(data_folder=prj.tbofs_folder, prj=prj, model=RegOfs.Model.TBOFS)
    ...
    def test_creation_of_Leofs(self):
        prj = SoundSpeedLibrary(data_folder=self.cur_dir)
        leofs = RegOfs(data_folder=prj.leofs_folder, prj=prj, model=RegOfs.Model.LEOFS)
    ...
    def test_creation_of_Creofs(self):
        prj = SoundSpeedLibrary(data_folder=self.cur_dir)
        creofs = RegOfs(data_folder=prj.creofs_folder, prj=prj, model=RegOfs.Model.CREOFS)
    ...
    def test_creation_of_Sfbofs(self):
        prj = SoundSpeedLibrary(data_folder=self.cur_dir)
        sfbofs = RegOfs(data_folder=prj.sfbofs_folder, prj=prj, model=RegOfs.Model.SFBOFS)
