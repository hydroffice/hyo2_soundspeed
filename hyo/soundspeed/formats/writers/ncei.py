...
from hyo.soundspeed import __version__ as ssp_version
from hyo.soundspeed import __doc__ as ssp_name
from hyo.soundspeed.formats.writers.abstract import AbstractWriter
