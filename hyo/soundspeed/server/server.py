...
class Server(Thread):
    ...
    def __init__(self, prj: Optional['hyo.soundspeed.soundspeed.SoundSpeedLibrary']):
    ...
    def check_settings(self) -> bool:
        ...
        if self.prj.setup.server_source == 'RTOFS':  # RTOFS case
            ...
            if self.prj.use_rtofs():
                ...
                self.prj.progress.end(text="RTOFS not in use")
                return False
        ...
        if self.prj.setup.server_source == 'WOA09':  # WOA09 case
            ...
            if self.prj.use_woa09():
                ...
                self.prj.progress.end(text="WOA09 not in use")
                return False
        ...
        if self.prj.setup.server_source == 'WOA13':  # WOA09 case
            ...
            if self.prj.use_woa13():
                ...
                self.prj.progress.end(text="WOA13 not in use")
                return False
        ...
        if not self.prj.use_sis():
            ...
            self.prj.progress.end(text="SIS not in use")
            return False
        ...
        if self.prj.listeners.sis.nav:
            ...
            self.prj.progress.end(text="SIS NAV missing")
            return False
        ...
        if num_live_clients == 0:
            ...
            self.prj.progress.end(text="Unable to confirm interaction with any clients")
            return False
