...
class RegOfsModel(IntEnum):
    ...
    @classmethod
    def skip_models(cls) -> tuple["RegOfsModel", ...]:
        return RegOfsModel.NYOFS, RegOfsModel.SJROFS
    ...
    @property
    def skip(self) -> bool:
        return self in self.skip_models()
    ...
    def lib_func_retrieve(self, lib: 'SoundSpeedLibrary') -> Callable[[], bool]:
        return getattr(lib, f"retrieve_{self.slug}")
